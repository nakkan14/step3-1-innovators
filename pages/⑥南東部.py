...
df_hospital = df_hospital[df_hospital['Block'] == '南東部地域']
df_supermarket = df_supermarket[df_supermarket['Block'] == '南東部地域']

# 地図の基本設定⇒locationを地区ブロックごとに調整する
m = folium.Map(
    location=[34.207303295766515, 135.22902236449048],
    tiles='OpenStreetMap',
    zoom_start=14
)
